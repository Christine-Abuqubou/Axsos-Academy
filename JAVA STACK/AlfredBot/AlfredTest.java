public class AlfredTest {
    public static void main(String[] args) {
        ...
        String testGuestGreeting2 = alfredBot.guestGreeting("Bruce Wayne", "evening");

        String alfredYellTest = alfredBot.alfredYell("sir, the Batmobile is missing");
        ...
        System.out.println(alfredYellTest);
    }
}
